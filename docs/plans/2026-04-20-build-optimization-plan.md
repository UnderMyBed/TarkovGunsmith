...
**Worktree:** This plan executes in `~/TarkovGunsmith/.worktrees/optimize` on branch `feat/m3-build-optimization` off `origin/main` (v1.6.0). Spec + plan commits are already present.
