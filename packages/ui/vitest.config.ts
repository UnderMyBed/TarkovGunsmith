 ...
 * jsdom is the exception). Both are sanctioned; this one is simpler for a
 * design-system package where nearly every test renders JSX.
 *
 * Thresholds are a RATCHET, not an aspiration. They are set to the coverage this
 * package actually achieves with real render tests (the baseline this replaced was
 * 15.85% statements over 5 lines, i.e. no real coverage at all).
