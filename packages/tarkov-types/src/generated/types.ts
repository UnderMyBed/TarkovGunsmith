...
export type CustomizationItem = {
  ...
  customizationTypeName: Scalars["String"]["output"];
  id: Scalars["ID"]["output"];
  imageLink?: Maybe<Scalars["String"]["output"]>;
  name: Scalars["String"]["output"];
};

export type CustomizationItemBasic = CustomizationItem & {
  customizationType: Scalars["String"]["output"];
  customizationTypeName: Scalars["String"]["output"];
  id: Scalars["ID"]["output"];
  imageLink?: Maybe<Scalars["String"]["output"]>;
...
export type CustomizationItems = CustomizationItem & {
  customizationType: Scalars["String"]["output"];
  customizationTypeName: Scalars["String"]["output"];
  id: Scalars["ID"]["output"];
  imageLink?: Maybe<Scalars["String"]["output"]>;
...
export type Item = {
  ...
  minLevelForFlea?: Maybe<Scalars["Int"]["output"]>;
  name?: Maybe<Scalars["String"]["output"]>;
...
export type Map = {
  ...
  btrStops?: Maybe<Array<Maybe<MapPositionNamed>>>;
  description?: Maybe<Scalars["String"]["output"]>;
...
export type Prestige = {
  conditions?: Maybe<Array<Maybe<TaskObjective>>>;
  iconLink?: Maybe<Scalars["String"]["output"]>;
  id: Scalars["ID"]["output"];
  imageLink?: Maybe<Scalars["String"]["output"]>;
  name?: Maybe<Scalars["String"]["output"]>;
  prestigeLevel?: Maybe<Scalars["Int"]["output"]>;
  rewards?: Maybe<TaskRewards>;
  transferSettings?: Maybe<Array<Maybe<PrestigeTransferSettings>>>;
};

export type PrestigeTransferSettings =
  PrestigeTransferSettingsSkill | PrestigeTransferSettingsStash;

export type PrestigeTransferSettingsSkill = {
  name?: Maybe<Scalars["String"]["output"]>;
  skillType?: Maybe<Scalars["String"]["output"]>;
  transferRate?: Maybe<Scalars["Float"]["output"]>;
};

export type PrestigeTransferSettingsStash = {
  gridHeight?: Maybe<Scalars["Int"]["output"]>;
  gridWidth?: Maybe<Scalars["Int"]["output"]>;
  itemFilters?: Maybe<ItemFilters>;
};
...
export type QueryItemsArgs = {
  ...
  categoryNames?: InputMaybe<Array<InputMaybe<Scalars["String"]["input"]>>>;
  gameMode?: InputMaybe<GameMode>;
  handbookCategoryNames?: InputMaybe<Array<InputMaybe<Scalars["String"]["input"]>>>;
...
export type RequirementType = "loyaltyLevel" | "playerLevel" | "questCompleted" | "stationLevel";
...
export type Task = {
  ...
  requiredPrestige?: Maybe<Prestige>;
...
export type TaskObjectiveHideoutStation = TaskObjective & {
  description: Scalars["String"]["output"];
  hideoutStation?: Maybe<HideoutStation>;
  id?: Maybe<Scalars["ID"]["output"]>;
  maps: Array<Maybe<Map>>;
  optional: Scalars["Boolean"]["output"];
  stationLevel?: Maybe<Scalars["Int"]["output"]>;
  type: Scalars["String"]["output"];
};
...
export type TaskRewards = {
  achievement: Array<Maybe<Achievement>>;
  craftUnlock: Array<Maybe<Craft>>;
  customization?: Maybe<Array<Maybe<CustomizationItem>>>;
